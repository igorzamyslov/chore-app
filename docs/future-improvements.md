...
also records two claim-state gaps found while writing it: unlinking
strands stale `members.userId` values locally, and the adopting device
never sets its own. F12 was deliberately excluded and stays deferred here.
